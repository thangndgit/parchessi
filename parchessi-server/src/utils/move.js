const { getOrder, getType } = require("./name");
const { getId } = require("./piece");

// Hàm lấy các MOVE xuất chuồng
exports.getMoveStart = (game, piece) => {
...
exports.getMoveRacing = (game, piece) => {
  // Lấy thứ tự của PIECE và loại NODE hiện tại
  const pieceOrder = getOrder(piece);
